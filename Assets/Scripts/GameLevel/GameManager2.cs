...
public class GameManager2 : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject bulut, bulut2, bulut3, bulut4,bulutici;
    ...
    {
        cocuk3.GetComponent<RectTransform>().DOLocalMoveX(-26, 5f).SetEase(Ease.InBack);
    }
    ...
    void BolumDegerleriniTexteYazdir()
    {
        foreach (var kare in karelerDizisi)
        {
            int rastgeleDeger = Random.Range(1, 18);
